# TASK-120: Biến đổi Bảo mật: Quy trình Làm mới Thông tin Xác thực (Security Transformation: Credential Hardening & Change Flow)

## 📋 Metadata

- **Task ID**: TASK-120
- **Độ ưu tiên**: 🔴 CHÍ TRỌNG (Security)
- **Phụ thuộc**: TASK-116 (Auth Flow), TASK-117 (Guards)
- **Trạng thái**: ✅ Done
...
| **3. Policy Check**   | So khớp mật khẩu mới với Quy tắc bảo mật (TASK-115). | Đảm bảo mật khẩu mới đủ mạnh.    |
