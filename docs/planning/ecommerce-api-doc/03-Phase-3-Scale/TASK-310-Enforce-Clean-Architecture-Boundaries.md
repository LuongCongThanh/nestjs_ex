...
- Các phụ thuộc chỉ được phép hướng vào bên trong (chỉ vào Core). Các lớp bên trong tuyệt đối không được biết về các lớp bên ngoài (ví dụ: Domain không được chứa code liên quan đến Prisma client hay Express).
