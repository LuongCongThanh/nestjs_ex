...
export class SetupAuthModule1768465976330 implements MigrationInterface {
  name = 'SetupAuthModule1768465976330';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "cart_items" DROP CONSTRAINT IF EXISTS "FK_cart_items_cart"`);
    ...
    await queryRunner.query(`ALTER TABLE "addresses" DROP CONSTRAINT IF EXISTS "FK_addresses_user"`);
    ...
    await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_categories_isActive"`);
    ...
    await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_products_sku"`);
    await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_products_categoryId"`);
    await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_products_isActive"`);
    await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_products_isFeatured"`);
    await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_products_categoryId_isActive"`);
    await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_products_isFeatured_isActive"`);
    ...
    await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_order_items_productId"`);
    ...
    await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_payments_transactionId"`);
    await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_payments_createdAt"`);
    await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_orders_orderNumber"`);
    ...
    await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_orders_paymentStatus"`);
    await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_orders_createdAt"`);
    await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_cart_items_cartId"`);
    await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_cart_items_productId"`);
    await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_cart_items_cartId_productId"`);
    await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_carts_userId"`);
    await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_carts_isActive"`);
    await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_carts_userId_isActive"`);
    await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_addresses_userId"`);
    await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_addresses_isDefault"`);
    await queryRunner.query(
      `CREATE TABLE "refresh_tokens" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "token" character varying(500) NOT NULL, "user_id" uuid NOT NULL, "expires_at" TIMESTAMP NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "user_agent" character varying(255), "ip_address" character varying(45), CONSTRAINT "UQ_4542dd2f38a61354a040ba9fd57" UNIQUE ("token"), CONSTRAINT "PK_7d8bee0204106019488c4c50ffa" PRIMARY KEY ("id"))`,
    );
